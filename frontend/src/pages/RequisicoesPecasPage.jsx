...
export default function RequisicoesPecasPage() {
  ...
  return <section className="page-section">
    ...
    <div className="responsibility-flow"><span><strong>1. Mecânico</strong> solicita a peça</span><b>→</b><span><strong>2. Administrador</strong> aprova ou recusa</span><b>→</b><span><strong>3. Sistema</strong> baixa e recalcula o estoque</span></div>
