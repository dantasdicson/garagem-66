...
export default function UsuariosPage() {
  ...
  return <section className="page-section">
    <div className="page-heading"><div><p className="eyebrow">Administração</p><h1>Colaboradores</h1><p className="lead">Gerencie administradores, atendentes e mecânicos da Garagem 66.</p></div><button className="button button-primary" onClick={limpar}>+ Novo colaborador</button></div>
