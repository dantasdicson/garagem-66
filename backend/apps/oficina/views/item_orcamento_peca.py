...
from ..models import ItemOrcamentoPeca, Orcamento
from ..serializers import ItemOrcamentoPecaSerializer
from ..services import remover_item_previsto


class ItemOrcamentoPecaViewSet(ModelViewSet):
    queryset = ItemOrcamentoPeca.objects.select_related("orcamento__ordem_servico__cliente", "peca").all()
    serializer_class = ItemOrcamentoPecaSerializer
